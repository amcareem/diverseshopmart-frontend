...
export const Moba = () => {
  return (
    <div className="moba">
            ...
            <div class="card">
                <img src={moba1} class="card-img-top" alt=""/>
                <div class="card-body">
                    <h5 class="card-title">ASPOR A323 Power Bank 10000mAh / 2 Input 2 Output</h5>
                    <p class="card-text">LKR. 2,350 </p>
                    <Rating
                        count={5}
                        size={24}
                        value={5} 
            ...
            <div class="card">
                <img src={moba2} class="card-img-top" alt=""/>
                <div class="card-body">
                    <h5 class="card-title">
...
Universal Lazy Phone Holder Desk Bed Side Colorful Flexible Long</h5>
            ...
            <div class="card">
                <img src={moba4} class="card-img-top" alt=""/>
                <div class="card-body">
                    <h5 class="card-title">
Full Glue Anti-Fingerprint Matte Tempered Glass for iPhone</h5>
            ...
            <div class="card">
                <img src={moba5} class="card-img-top" alt=""/>
                <div class="card-body">
                    <h5 class="card-title">
Charger 3 in 1 USB Cable for iPhone, All Android Phones</h5>
                    <p class="card-text">LKR. 400</p>
                    <Rating
                        count={5}
                        size={24}
                        value={4} // You can set the initial value dynamically based on your product rating
            ...
            <div class="card">
                <img src={moba6} class="card-img-top" alt=""/>
                <div class="card-body">
                    <h5 class="card-title">
Universal Car Mount Holder for Mobile Phone with Suction Cup</h5>
                    <p class="card-text">LKR. 959 </p>
                    <Rating
                        count={5}
                        size={24}
                        value={2} 
            ...
            <div class="card">
                <img src={moba7} class="card-img-top" alt=""/>
                <div class="card-body">
                    <h5 class="card-title">
Denmen High Speed Data Cable 2.4A For Type C/ Micro USB/</h5>
                    <p class="card-text">LKR. 279 </p>
                    <Rating
                        count={5}
                        size={24}
                        value={3} 
            ...
            <div class="card">
                <img src={moba8} class="card-img-top" alt=""/>
                <div class="card-body">
                    <h5 class="card-title">
Phone cover Waterproof Cover Pouch Bag Cases Water proof</h5>
                    <p class="card-text">LKR. 410 </p>
                    <Rating
                        count={5}
                        size={24}
                        value={4} 
            ...
            <div class="card">
                <img src={moba9} class="card-img-top" alt=""/>
                <div class="card-body">
                    <h5 class="card-title">
Full Cover Protective Glass For iPhone 13 12 11 Pro Max Mini X</h5>
            ...
            <div class="card">
                <img src={moba10} class="card-img-top" alt=""/>
                <div class="card-body">
                    <h5 class="card-title">Phone Holder with Hook Wall Sticky on Wall Stand </h5>
                    <p class="card-text">LKR. 340 </p>
                    <Rating
                        count={5}
                        size={24}
                        value={4} 
            ...
            <div class="card">
                <img src={moba11} class="card-img-top" alt=""/>
                <div class="card-body">
                    <h5 class="card-title">Mob Phone Holder</h5>
                    <p class="card-text">LKR. 320 </p>
                    <Rating
                        count={5}
                        size={24}
                        value={3} 
            ...
            <div class="card">
                <img src={moba12} class="card-img-top" alt=""/>
                <div class="card-body">
                    <h5 class="card-title">
Ultimate Matte Tempered Glass Screen Protector for Xiaomi</h5>
                    <p class="card-text">LKR. 499 </p>
                    <Rating
                        count={5}
                        size={24}
                        value={4} 
