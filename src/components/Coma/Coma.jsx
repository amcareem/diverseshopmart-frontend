...
export const Coma = () => {
  return (
    <div className="coma">
            ...
            <div class="card">
                <img src={coma1} class="card-img-top" alt=""/>
                <div class="card-body">
                    <h5 class="card-title">
Ergonomic Foldable Laptop Stand Holder - for Any Windows Laptop,</h5>
            ...
            <div class="card">
                <img src={coma2} class="card-img-top" alt=""/>
                <div class="card-body">
                    <h5 class="card-title">
Ergonomic Foldable Laptop Stand Holder - for Any Windows Laptop</h5>
            ...
            <div class="card">
                <img src={coma3} class="card-img-top" alt=""/>
                <div class="card-body">
                    <h5 class="card-title">
1080P HDMI to VGA Converter For Xbox Ps3 Ps4 PC TV LEDs </h5>
            ...
            <div class="card">
                <img src={coma4} class="card-img-top" alt=""/>
                <div class="card-body">
                    <h5 class="card-title">
Logitech High Quality Non-Skid Mouse Pad (22cm*18cm)</h5>
            ...
            <div class="card">
                <img src={coma5} class="card-img-top" alt=""/>
                <div class="card-body">
                    <h5 class="card-title">
Old World Map / Razer Goliathus Professional Large Gaming</h5>
            ...
            <div class="card">
                <img src={coma6} class="card-img-top" alt=""/>
                <div class="card-body">
                    <h5 class="card-title">
MetalMaster Laptop Stand - Ergonomic Foldable Laptop</h5>
            ...
            <div class="card">
                <img src={coma7} class="card-img-top" alt=""/>
                <div class="card-body">
                    <h5 class="card-title">
HT208 Heavy Bass Multimedia Speaker </h5>
            ...
            <div class="card">
                <img src={coma8} class="card-img-top" alt=""/>
                <div class="card-body">
                    <h5 class="card-title">
Laptop Skin Protector 4 In 1 Pack for 15.6 inch</h5>
            ...
            <div class="card">
                <img src={coma9} class="card-img-top" alt=""/>
                <div class="card-body">
                    <h5 class="card-title">
Premium CAT6 10m 15m 20m 30m 50M 75M 100M </h5>
            ...
            <div class="card">
                <img src={coma10} class="card-img-top" alt=""/>
                <div class="card-body">
                    <h5 class="card-title">
JEDEL K13 USB Wired Basic Gaming Keyboard For Desktop </h5>
            ...
            <div class="card">
                <img src={coma11} class="card-img-top" alt=""/>
                <div class="card-body">
                    <h5 class="card-title">
Wireless Bluetooth Speaker Rechargeable Light</h5>
            ...
            <div class="card">
                <img src={coma12} class="card-img-top" alt=""/>
                <div class="card-body">
                    <h5 class="card-title">
USB Bluetooth Adapter Dongle Wireless Audio Receiver</h5>
            ...
            <div class="card">
                <img src={coma13} class="card-img-top" alt=""/>
                <div class="card-body">
                    <h5 class="card-title">
