...
export const Skin = () => {
  return (
    <div className="skin">
            ...
            <div class="card">
                <img src={skin1} class="card-img-top" alt=""/>
                <div class="card-body">
                    <h5 class="card-title">
DR.RASHEL Vitamin C Brightening & Anti ageing Face Serum 50ml</h5>
                    <p class="card-text">LKR. 800 </p>
                    <Rating
                        count={5}
                        size={24}
                        value={5} 
            ...
            <div class="card">
                <img src={skin2} class="card-img-top" alt=""/>
                <div class="card-body">
                    <h5 class="card-title">
Lip Therapy Rosy Lips - 7g</h5>
            ...
            <div class="card">
                <img src={skin3} class="card-img-top" alt=""/>
                <div class="card-body">
                    <h5 class="card-title">Dr.Rashel Vitamin C Brightening & Anti-Aging Night Cream 50g</h5>
                    <p class="card-text">LKR. 1200 </p>
                    <Rating
                        count={5}
                        size={24}
            ...
            <div class="card">
                <img src={skin4} class="card-img-top" alt=""/>
                <div class="card-body">
                    <h5 class="card-title">
Roushun 99% Aloe Vera Soothing Gel Face Moisturizer - 300m</h5>
                    <p class="card-text">LKR. 840 </p>
                    <Rating
                        count={5}
                        size={24}
                        value={4} 
            ...
            <div class="card">
                <img src={skin5} class="card-img-top" alt=""/>
                <div class="card-body">
                    <h5 class="card-title">
Cliara Botanical Acne Control Face Wash 100Ml</h5>
                    <p class="card-text">LKR. 1400</p>
                    <Rating
                        count={5}
                        size={24}
                        value={4} // You can set the initial value dynamically based on your product rating
            ...
            <div class="card">
                <img src={skin6} class="card-img-top" alt=""/>
                <div class="card-body">
                    <h5 class="card-title">
Fresh and white beauty cream</h5>
                    <p class="card-text">LKR. 779 </p>
                    <Rating
                        count={5}
                        size={24}
                        value={2} 
            ...
            <div class="card">
                <img src={skin8} class="card-img-top" alt=""/>
                <div class="card-body">
                    <h5 class="card-title">Dr.Rashel Gold Collagen Sun Cream (SPF 100) – 80g</h5>
                    <p class="card-text">LKR. 1,590 </p>
                    <Rating
                        count={5}
                        size={24}
                        value={4} 
            ...
            <div class="card">
                <img src={skin9} class="card-img-top" alt=""/>
                <div class="card-body">
                    <h5 class="card-title">Pure & Natural Beet Root Powder 50g face mask</h5>
